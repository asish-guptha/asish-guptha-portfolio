    ...
    <section id="process" className="min-h-screen flex items-center justify-center px-6 sm:px-12 lg:px-32 relative  py-24">
      <div className="w-full max-w-7xl flex flex-col gap-12 z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} viewport={{ once: false, amount: 0.4 }} className="bg-darkBg border border-textMuted/20 p-8 rounded-xl hover:border-accent/50 transition-all duration-300 relative group">
          ...
          <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} viewport={{ once: false, amount: 0.4 }} className="bg-darkBg border border-textMuted/20 p-8 rounded-xl hover:border-accent/50 transition-all duration-300 relative group">
          ...
          <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }} viewport={{ once: false, amount: 0.4 }} className="bg-darkBg border border-textMuted/20 p-8 rounded-xl hover:border-accent/50 transition-all duration-300 relative group">
          ...
          <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4 }} viewport={{ once: false, amount: 0.4 }} className="bg-darkBg border border-textMuted/20 p-8 rounded-xl hover:border-accent/50 transition-all duration-300 relative group">
